          ...
          <figure className="relative overflow-hidden">
                ...
                {index === currentImageIndex && (
                  <>
                    {item.endsWith(".mp4") || item.endsWith(".webm") ? (
                      ...
                      <LazyloadComponent
                        image={item}
                        classname="w-full h-[400px] lg:h-[550px] object-cover aspect-square shrink shrink-0 md:rounded-md"
                      />
                    )}
                  </>
                )}
            ...
            <>
              {currentImageIndex < post?.media?.length - 1 && (
                <button
                  onClick={handleNext}
                  className="absolute right-2 top-1/2 btn btn-circle btn-sm opacity-79 hover:opacity-100"
                >
            ...
            <>
              {currentImageIndex > 0 && (
                <button
                  ...
                  className="absolute left-2 top-1/2 btn btn-circle btn-sm opacity-79 hover:opacity-100"
                >
